<template>
    <main class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 ml-2 w-full mb-4">
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="rounded-t-lg" src="/src/assets/img/image-1.jpg" alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <!-- Repite el código de la tarjeta según sea necesario -->
    </main>
</template>
